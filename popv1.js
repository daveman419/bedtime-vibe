...
document.addEventListener('mousedown', (e) => {
  longPressTimer = setTimeout(() => spawnFloatingStar(e.clientX, e.clientY), 500);
});
...
document.addEventListener('touchstart', (e) => {
  ...
  longPressTimer = setTimeout(() => spawnFloatingStar(touch.clientX, touch.clientY), 500);
});
document.addEventListener('touchend', () => clearTimeout(longPressTimer));

// Double click or double tap
document.addEventListener('dblclick', (e) => {
  spawnFloatingStar(e.clientX, e.clientY);
});
document.addEventListener('touchend', (e) => {
  if (!tapTimeout) {
    ...
    spawnFloatingStar(touch.clientX, touch.clientY);
  }
});
